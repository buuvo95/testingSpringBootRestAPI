...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("firstname", "Buu");
        request.setParameter("lastname", "Vo");
        request.setParameter("emailAddress", "buuvo95@gmail.com");
    }
    ...
    public void createStudentHttpRequest() throws Exception {
        student.setFirstname("Buu");
        student.setLastname("Vo");
        student.setEmailAddress("bvo@gmail.com");

        mockMvc.perform(post("/")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(student))) //Generate a Json string from the Java Object
                .andExpect(status().isOk())
                .andExpect(jsonPath("$",hasSize(2)));

        CollegeStudent verifyStudent = studentDao.findByEmailAddress("bvo@gmail.com");
    ...
    @Test
    public void studentInformationHttpEmptyResponse() throws Exception {
    ...
    @Test
    public void deleteAValidGradeHttpRequestStudentIDDoesNostExistEmptyResponse() throws Exception {
